...
// @description    Fleetlog parser for French AT
// @include        *://*.ogame.gameforge.*/game/admin2/flottenlog.php?uid=*&list=*
// @include        *://*.ogame.gameforge.*/game/admin2/flottenlog.php?showplanet=*
// @version        12.04.2017
// @updateURL    https://github.com/Neshi/Og/raw/main/scripts/FleetLogBeatuifier.user.js
// @downloadURL  https://github.com/Neshi/Og/raw/main/scripts/FleetLogBeatuifier.user.js
// @grant          none
// ==/UserScript==
...
//** Warning : version destined to FRENCH version of AdminTool (LNG_FLEET_ARRIVES_TO_TARGET)**
...
(function() {
    var LNG_START_BUTTON = 'Upieksz logi!';
    ...
    var LNG_ESPIONAGE = 'Szpieguj';
    var LNG_ATTACK = 'Atakuj';
    var LNG_TRANSPORT = 'Transportuj';
    var LNG_HARVEST = 'Zbieraj';
    var LNG_DEPLOYMENT = 'Stacjonuj';
    var LNG_EXPEDITION = 'Ekspedycja';
    var LNG_ACS_ATTACK = 'Atak ACS';
    var LNG_COLONIZATION = 'Kolonizuj';
    var LNG_MOON_DESTRUCTION = 'Niszcz';
    var LNG_ACS_DEFEND = 'Obrona ACS';
    var LNG_IPM = 'RMP';
    // table header text
    var LNG_HDR_MISSION = 'Misja';
    var LNG_HDR_PLAYER1 = 'Gracz 1';
    var LNG_HDR_PLAYER2 = 'Gracz 2';
    var LNG_HDR_ORIGIN = 'Od';
    var LNG_HDR_DESTINATION = 'Do';
    var LNG_HDR_LAUNCH = 'Start';
    var LNG_HDR_ARRIVAL = 'Przylot';
    var LNG_HDR_RESOURCES = 'Surowce';
    var LNG_HDR_FLEET = 'Flota';
    var LNG_HDR_RETURN_TIME = 'Powrót';
    var LNG_HDR_RETURN_RES = 'Surowce';
    var LNG_HDR_RETURN_FLEET = 'Flota';
    // coordinates stuff
    var LNG_SHORT_DF = 'D';
    ...
    var mission =  {
      ...
      Def: 'Obrona ACS',
      Ipm: 'Rakiety',
      returns: 'Ukryj/pokaż logi'
    };
    var LNG_OLD_LOGS_BUTTON = 'Old logs';
    // misc+missions
    var LNG_CONV_DF = /^debris field/;
    var LNG_CONV_MOON = /\(M\) \[/;
    //Copy EXACTLY like it appears in admin tool
    var LNG_FLEET_ARRIVES_TO_TARGET = 'Aller';
    var LNG_SPACE_PLAYER_NAME = 'space';
    var LNG_UNKNOWN_PLAYER_NAME = 'Nieznany';
    var LNG_UNKNOWN_PLANET_NAME = 'Nieznany';
    ...
    CONV['Small Cargo'] = 'SC';
    CONV['Large Cargo'] = 'LC';
    CONV['Light Fighter'] = 'LF';
    CONV['Heavy Fighter'] = 'HF';
    CONV['Cruiser'] = 'CR';
    CONV['Espionage Probe'] = 'ESP';
    CONV['Battleship'] = 'BS';
    CONV['Bomber'] = 'BOM';
    CONV['Battlecruiser'] = 'BC';
    CONV['Destroyer'] = 'DES';
    CONV['Deathstar'] = 'RIP';
    CONV['Colony Ship'] = 'COL';
    CONV['Recycler'] = 'REC';
    CONV['Solar Sattellite'] = 'SAT';
    // END OF CONFIG
    // *********************
