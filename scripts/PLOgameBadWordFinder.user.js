...
//** Updated at 06/12/2015 by Shole**
//** Updated at 20/01/2020 by v0ldem0rt**
//** Updated at 29/12/2022 by Neshi**
	...
	function DoModify(){
		...
		GM_xmlhttpRequest({
			...
			// type here the URL with the badwords
			 url: 'https://raw.githubusercontent.com/Neshi/Og/main/data/badwords-pl.html',
		...
		function DoModifyRun(){
			...
			$('GM_ActivateButton').textContent = 'Znaleziono  ' + count2 + ' wulgi i '+count+' nazwy ze znakami specjalnymi';
		}
